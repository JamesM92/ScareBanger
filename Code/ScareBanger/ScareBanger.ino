/*
This is a remix of the original Octobanger firmware provided by the octobanger softwar,e only real changes are the pin assignments to allow use of purpose dedicated pins.

To generate the hex file, in the arduino ide options select the verbose output this will create a temp file witht he hex codes needed to upload to a nano later using the octobanger software.
*/
/*
*************Octo Banger TTL*********
